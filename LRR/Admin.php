...
<div class="row" style="width: 80%;margin: auto;">
 ...
 <!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#menu2">Batch Add New Accounts</a>
    </li>
  </ul>
  ...
  <div class="tab-content">
    ...
    <div id="home" class="container tab-pane active"><br>
     ...
     <form method="post" action="Script.php">
                   	<input type="hidden" name="frm_createlecturrer" value="true" required=""/>Full_Name
		<input type="text" name="fullname" placeholder="Full Name" class="form-control" required="">Email
		<input type="text" name="email" placeholder="Email / Student Number" class="form-control" required="">Passport_Number / ID (Used as Intial Password)
...
?></table>    
   	...
   	<div id="menu2"  class="container tab-pane fade" style="margin-top:10px" >
		</b>Please separate accounts with spaces</b><br>
		<form action="batch_insert.php" method="post">
			<textarea cols="54" rows="8" name="users" required=""></textarea>
			</b>Email_type</b>
			<input type="text" name="email_type" placeholder="Email_type" class="form-control" required="">
			</b>Passport_Number / ID (Used as Intial Password)</b>
			<input type="text" name="pass" placeholder="Passport No./ID" class="form-control" required="">
			<br> User Type : 
  			<input type="radio" name="type" value="Lecturer" required=""> Lecturer
     			<input type="radio" name="type" value="TA" required=""> T/A
